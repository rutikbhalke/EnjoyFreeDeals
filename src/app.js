...
const trackPriceRoutes = require("./routes/trackPriceRoutes");
const sharedDealRoutes = require("./routes/sharedDealRoutes");
const recentlyViewedRoutes = require("./routes/recentlyViewedRoutes");
const upvotedDealRoutes = require("./routes/upvotedDealRoutes");
...
app.use("/api/upvoted-deals", upvotedDealRoutes);
app.use("/api/price-alerts", priceAlertRoutes);
app.use("/api/price-comparisons", priceComparisonRoutes);
app.use("/api/price-history", priceHistoryRoutes);
app.use("/api/track-price", trackPriceRoutes);
