...
fun JSONObject.toDealModel(): DealModel {
    ...
    return DealModel(
        ...
        buyScore = optIntValue("buyScore", "buy_score").takeIf { it > 0 },
        buyScore15Days = optIntValue("buyScore15Days", "buy_score_15_days").takeIf { it > 0 },
        buyScore30Days = optIntValue("buyScore30Days", "buy_score_30_days").takeIf { it > 0 },
        priceTrend = optStringValue("priceTrend", "price_trend").ifBlank { null },
        dealScore = optIntValue("dealScore", "deal_score").takeIf { it > 0 },
        isBestPrice = optBooleanValue("isBestPrice", "is_best_price"),
