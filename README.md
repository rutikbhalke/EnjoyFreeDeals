...
- The default Android backend URL is `https://freedeals1.vercel.app`.
...
- Default web API URL is `https://freedeals1.vercel.app`.
...
```bash
VITE_API_BASE_URL=https://freedeals1.vercel.app
